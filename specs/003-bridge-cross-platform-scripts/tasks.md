...
- [ ] T039 [US3] Smoke-test: `pwsh scripts/release/build-extension-zip.ps1 -Version 0.4.0`. Unpack the resulting `dist/speckit-superpowers-bridge-v0.4.0.zip` to a temp dir. Verify it contains BOTH `scripts/powershell/` (4 .ps1) AND `scripts/bash/` (4 .sh) under the top-level `speckit-superpowers-bridge-0.4.0/` wrapper.
